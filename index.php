                                ...
                                <div class="mb-4">
                                    <div class="form-outline mb-4">
                                        <label for="documento" class="nav-link" > &nbsp;<strong>DOCUMENTO </strong></label>
                                            <input type="text" id="usuario" name="documento" class="form-control Input"  maxlength="15" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-outline mb-4">
                                <div class="mb-4">
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="password" id="c1" class="form-control Input" name="contrasena" maxlength="15" required>   
                                    </div>
                                </div>
                            </div>
                        </div>
